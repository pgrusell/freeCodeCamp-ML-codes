...
# Build the NN
neural_network = NN(n_layers=2, n_neurons=32,
                    x_data=x_data, y_data=y_data, activation='tanh')
neural_network.build()
neural_network.train(obj=0.001, eta=1e-3)

# Testing
x_test = npr.uniform(-10, 10, (50_000, 2))
